  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved race as @race" do
        ...
        post :create, {:race => { "name" => "invalid value" }}, valid_session
        assigns(:race).should be_a_new(Race)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested race" do
        ...
        Race.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => race.to_param, :race => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the race as @race" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Race.any_instance.stub(:save).and_return(false)
        put :update, {:id => race.to_param, :race => { "name" => "invalid value" }}, valid_session
        assigns(:race).should eq(race)
      end
